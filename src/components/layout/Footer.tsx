...
export function Footer() {
    return (
        <footer className="bg-secondary/30 pt-24 pb-12 relative overflow-hidden border-t border-primary/5">
            {/* Wave Background (Bottom) - Intertwined Layers (Static & Muted) */}
            <div className="absolute bottom-0 left-0 right-0 z-0 overflow-hidden h-64 pointer-events-none opacity-70">
