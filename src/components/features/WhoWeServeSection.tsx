        ...
        <section className="py-24 bg-white relative scroll-mt-20 border-t border-primary/5" id="who-we-serve">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="text-center max-w-2xl mx-auto mb-16">
                    ...
                    <h3 className="mt-2 text-3xl font-bold font-heading text-primary sm:text-4xl">Who We Serve</h3>
                                ...
                                <div className="h-full flex flex-col relative overflow-hidden p-2 rounded-[1.5rem] bg-white border border-border transition-all duration-500 hover:shadow-[0_20px_50px_rgba(41,54,129,0.06)] hover:-translate-y-2">
                                    <div className="flex-1 p-6 md:p-8 flex flex-col items-center text-center relative z-10">
                                        <div className="flex gap-2 mb-8">
                                            <span className="px-3 py-1 rounded-full bg-[#EBF5FF] text-primary text-[10px] font-bold uppercase tracking-wider ring-1 ring-primary/10">Active</span>
                                        ...
                                        <div className="w-20 h-20 rounded-[2rem] bg-accent flex items-center justify-center text-primary mb-8 group-hover:scale-110 group-hover:bg-primary group-hover:text-white transition-all duration-500 shadow-sm ring-4 ring-white">
